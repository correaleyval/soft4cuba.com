  ...
  <div id="about" class="section section-about-us">
    <div class="container">
      ...
      <div class="section-story-overview">
        <div class="row">
          <div class="col-md-6">
            <div class="image-container image-left" style="background-image: url('img/2.jpg')">
              ...
              <p class="blockquote blockquote-primary">
                ...
                <a
                  ...
                  class="btn btn-primary btn-icon btn-round mr-5"
                  target="_blank"
                >
            ...
            <div class="image-container" style="background-image: url('img/3.jpg')"></div>
          </div>
          <div class="col-md-5">
            <!-- First image on the right side, above the article -->
            <div class="image-container image-right" style="background-image: url('img/1.jpg')"></div>
            <p>
              ...
              las tecnologías de la comunicación y la información y con ello promover en el empleo
              de la informatización en las diferentes esferas de la vida práctica de nuestro país.
            </p>
            <p>
              Todos los integrantes de la comunidad con sus proyectos o propuestas serán dignos de
